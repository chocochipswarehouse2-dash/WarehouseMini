...
-- ============================================================
-- 11. TABEL PENGELOLAAN REJECT, CUCI, PERMAK & DEFECT
-- ============================================================
CREATE TABLE IF NOT EXISTS public.perbaikan_tickets (
  id BIGINT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
  ticket_no TEXT UNIQUE NOT NULL,               -- e.g. RJC-20260904-001
  tanggal TIMESTAMPTZ DEFAULT now(),
  sku TEXT NOT NULL,
  nama_produk TEXT NOT NULL,
  size TEXT DEFAULT '-',
  qty NUMERIC DEFAULT 1,
  lokasi_asal TEXT DEFAULT 'Warehouse',         -- Rak asal sebelum ditarik
  lokasi_sekarang TEXT DEFAULT 'PERBAIKAN-01',  -- Rak fisik saat ini (e.g. CC001, PMK001, DF014)
  is_already_in_repair BOOLEAN DEFAULT false,   -- True jika stok fisik memang sudah ada di area perbaikan
  sumber_barang TEXT DEFAULT 'Gudang',          -- 'Gudang', 'Retur Marketplace', 'Produksi CMT', 'Live/Studio', 'Toko'
  kategori_rusak TEXT NOT NULL,                 -- 'Noda / Kotor', 'Jahitan Rusak', 'Kancing / Resleting', 'Kain Robek / Bolong', 'Cacat Bahan', 'Lainnya'
  detail_kerusakan TEXT DEFAULT '',             -- Deskripsi detail kendala
  foto_urls JSONB DEFAULT '[]'::jsonb,          -- Array URL/Base64 WebP terkompresi (35-60KB)
  foto_sesudah JSONB DEFAULT '[]'::jsonb,       -- Foto hasil sesudah cuci/permak
  tahap TEXT DEFAULT 'REJECT',                  -- 'REJECT', 'CUCI', 'PERMAK', 'DEFECT', 'SELESAI_GRADE_A', 'SELESAI_DEFECT_SALE', 'SELESAI_SCRAP'
  status_pengerjaan TEXT DEFAULT 'PENDING',     -- 'PENDING', 'SEDANG_PROSES', 'SELESAI_CUCI', 'SELESAI_PERMAK', 'GAGAL'
  qc_pic TEXT,                                  -- Nama Kepala QC / Petugas Sortir
  qc_tanggal TIMESTAMPTZ,
  qc_catatan TEXT DEFAULT '',
  petugas_reparasi TEXT,                        -- Nama penjahit / vendor laundry
  reparasi_mulai TIMESTAMPTZ,
  reparasi_selesai TIMESTAMPTZ,
  reparasi_catatan TEXT DEFAULT '',
  biaya_reparasi NUMERIC DEFAULT 0,
  acc_harga_defect NUMERIC DEFAULT 0,           -- Nilai harga jual obral defect jika disetujui
  acc_harga_by TEXT,                            -- Nama Manager/Superadmin yang meng-ACC harga
...
CREATE INDEX IF NOT EXISTS idx_perbaikan_lokasi ON public.perbaikan_tickets(lokasi_sekarang);
...
ALTER PUBLICATION supabase_realtime ADD TABLE public.perbaikan_tickets;
