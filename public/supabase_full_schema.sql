...
CREATE INDEX IF NOT EXISTS idx_log_produk_type_created ON public.log_produk(type, created_at DESC);
...
CREATE INDEX IF NOT EXISTS idx_stock_opname_invoice ON public.stock_opname_queue(invoice);
