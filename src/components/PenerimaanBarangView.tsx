      ...
      {activeTab === 'input' ? (
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
          ...
          <div className="space-y-1.5">
            ...
            <input type="text" placeholder="Contoh: PT. Sumber Makmur" className="w-full px-2 py-2 bg-slate-50 dark:bg-slate-800/50 border border-slate-200 dark:border-slate-700 rounded-xl text-sm focus:ring-2 focus:ring-primary-500 outline-none" />
          </div>
        </div>
            ...
            <table className="w-full text-left text-sm whitespace-nowrap">
              <thead className="bg-slate-50 dark:bg-slate-800/50 text-xs text-slate-500 dark:text-slate-400">
                <tr>
                  ...
                  <th className="px-2 py-3 font-bold">No. Resi/SJ</th>
                  <th className="px-2 py-3 font-bold">Supplier</th>
                  <th className="px-2 py-3 font-bold">Total Item</th>
              ...
              <tbody className="divide-y divide-slate-100 dark:divide-slate-800">
                {[1, 2, 3].map((item) => (
                  <tr key={item} className="hover:bg-slate-50/50 dark:hover:bg-slate-800/30">
                    <td className="px-2 py-3 text-slate-600 dark:text-slate-300">10:{item * 15} WIB</td>
                    <td className="px-2 py-3 font-mono text-slate-900 dark:text-slate-100 font-bold">RESI-88{item}90{item}</td>
                    <td className="px-2 py-3 text-slate-600 dark:text-slate-300">PT. Supplier {item}</td>
                    <td className="px-2 py-3 text-slate-600 dark:text-slate-300">{item * 2 + 1} Dus</td>
