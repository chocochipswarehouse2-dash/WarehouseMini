...
export const StockOpnameView: React.FC<StockOpnameViewProps> = React.memo(({
  ...
  return (
    <div id="stockOpnameViewContainer" className="space-y-2 max-w-7xl mx-auto pb-12">
      {/* Top Header Card */}
      <div className="bg-white dark:bg-[#09090B] border border-slate-200 dark:border-slate-800 rounded-2xl p-2 sm:p-3 shadow-sm">
      ...
      <div className="bg-white dark:bg-[#09090B] border border-slate-200 dark:border-slate-800 rounded-2xl overflow-hidden shadow-sm">
        {isLoading ? (
          ...
          <div className="py-16 px-3 text-center space-y-3">
            ...
            <button
              onClick={loadSoData}
              className="px-2 py-2 text-xs font-bold bg-emerald-600 text-white rounded-xl shadow-md cursor-pointer"
            >
              Coba Lagi
            </button>
          </div>
              ...
              <table className="w-full min-w-[850px] text-left text-xs border-collapse">
                <thead>
                  <tr className="bg-slate-50 dark:bg-slate-900/80 border-b border-slate-200 dark:border-slate-800 text-[11px] font-black text-slate-500 dark:text-slate-400 uppercase tracking-wider">
                    ...
                    <th className="py-3 px-2">Tanggal & Sesi</th>
                    <th className="py-3 px-2">SKU & Produk</th>
                    <th className="py-3 px-2">Lokasi Rak</th>
                    <th className="py-3 px-2 text-center">Sistem</th>
                    <th className="py-3 px-2 text-center">Fisik</th>
                    <th className="py-3 px-2 text-center">Selisih</th>
                    <th className="py-3 px-2">Status & Otorisasi</th>
                  ...
                  {filteredQueue.slice(0, displayLimit).map((item) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        {/* Qty Sistem */}
                        <td className="py-3 px-2 text-center font-mono font-bold text-slate-600 dark:text-slate-400">
                          {item.qty_sistem || 0}
                        </td>

                        {/* Qty Fisik */}
                        <td className="py-3 px-2 text-center font-mono font-black text-slate-900 dark:text-slate-100">
                          {item.qty_fisik || 0}
                        </td>
