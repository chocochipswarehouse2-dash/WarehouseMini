...
const ALL_MIGRATION_TABLES: Omit<TableMigrationItem, 'sourceCount' | 'targetCount' | 'transferredCount' | 'status' | 'selected'>[] = [
  ...
  { name: 'penerimaan_mutasi_store', label: '11B. Penerimaan Mutasi Store (penerimaan_mutasi_store)' },
  { name: 'penerimaan_paket', label: '11C. Penerimaan Paket Ekspedisi (penerimaan_paket)' },
  { name: 'ekspedisi_config', label: '11D. Konfigurasi Ekspedisi (ekspedisi_config)' },
  ...
  { name: 'pengiriman_store_reports', label: '16B. Pengiriman Store Dispatched (pengiriman_store_reports)' },
  { name: 'pengiriman_store_trips', label: '16C. Pengiriman Store Trips & SJ (pengiriman_store_trips)' },
  { name: 'pengiriman_paket_handover', label: '16D. Handover Manifest Paket (pengiriman_paket_handover)' },
  ...
  { name: 'wms_notes', label: '20B. Catatan & Sticky Notes (wms_notes)' },
